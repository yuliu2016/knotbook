package knotbook.formulas

import knotbook.formulas.function.Formula
import knotbook.formulas.function.FunctionFormula
import ca.warp7.rt.ext.formulas.token.*
import knotbook.formulas.token.*
import knotbool.formulas.token.*
...
class ExpressionEnvironment(val curDf: String, var dfs: MutableMap<String, DataFrame>) {
    ...
    private val funcs: MutableMap<String, Formula> = mapOf(
            ...
            "mode" to FunctionFormula { args ->
                args.maxBy { by -> args.filter { it == by }.size } ?: 0.0
            },
            "median" to FunctionFormula { args ->
                args.sorted().let {
